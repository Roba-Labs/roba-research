...
import function_catalog as functions
from syntax_nodes import ValueType
...
with open("../templates/kernel.cc.template") as f:
    content = f.read()
    ...
    with open("../generated/kernel.compiled.cc", mode="w") as f:
        f.write(content)

with open("../templates/module.types.template.d.ts") as f:
    content = f.read()
    ...
    with open("../../distribution/runtime/wasm/simforge-runtime.d.ts", mode="w") as f:
        f.write(content)
